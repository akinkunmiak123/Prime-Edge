...
export default function FloatingButtons() {
  ...
  // Show WhatsApp button after 2 seconds
  useEffect(() => {
  ...
  const whatsappNumber = '447XXXXXXXXX' // ← replace with client WhatsApp number e.g. 447912345678
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            transform: waChatOpen ? 'scale(1) translateY(0)' : 'scale(0.85) translateY(8px)',
          ...
          >
            ...
            <div className="bg-white px-5 py-5">
              ...
              >
                ...
                <br /><br />
                How can we help you today? We are happy to answer any questions about our services.
              </div>
